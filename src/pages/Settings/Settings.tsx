      ...
      >
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="md:w-2/3 p-8 flex flex-col">
            ...
            <div className="mt-8">
              <button className="w-full md:w-auto px-8 py-3 flex items-center justify-center bg-gradient-to-r from-purple-900 to-orange-800 text-white rounded-lg hover:from-purple-700 hover:to-indigo-700 text-lg font-semibold transition-all duration-500 ease-in-out hover:scale-105">
